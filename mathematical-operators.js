...
// ==========================================
const additionAndMultiply = (4+3) * 7;
console.log(additionAndMultiply);

// ==========================================
// 4. Declareer een variabele en sla daar de uitkomst van 36 gedeeld door 6, maal 2 in op.          // geeft 12 wanneer gelogd
// ==========================================
const divisionAndMultiply = 36 / 6 * 2;
console.log(divisionAndMultiply);
...
// ==========================================
const foodTaste = "zoet";
const foodTexture = "sappig";
console.log(foodTaste+foodTexture);
...
// ==========================================
const firstName = "Remco";
const lastName = "Schut";
...
// ==========================================
const myCity = "leerdam";
const myProvince = "Utrecht";
console.log(myCity+",", myProvince);